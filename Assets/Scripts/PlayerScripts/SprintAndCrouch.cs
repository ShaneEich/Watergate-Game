...
public class SprintAndCrouch : MonoBehaviour
{
    ...
    private float courch_Step_Distance = 0.5f;
    ...
    void Sprint()
    {
        if (sprint_Value > 0)
        {
            ...
            {
                playerMotor.speed = sprint_Speed;
    ...
    void Crouch()
    {
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            else
            {
                ...
                playerMotor.speed = crouch_Speed;

                player_Footsteps.step_Distance = courch_Step_Distance;
